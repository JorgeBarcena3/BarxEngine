...
#ifndef BARX_ENGINE_BCAPSULLECOLLIDERCOMPONENT
#define BARX_ENGINE_BCAPSULLECOLLIDERCOMPONENT
 ...
 */
class BCapsulleColliderComponent : public BColliderComponent
{
...
public:
    ...
    float                       radius; ///< Offset máximo de la caja, la base es el origen
    float                       height; ///< Offset máximo de la caja, la base es el origen

    /**
    * Constructor de una caja
    */
    BCapsulleColliderComponent(shared_ptr <BEntity> parent);
